  ...
  return (
    <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 20 }}>
      <style>{`
        ...
        .badge-yellow { background-color: #fef7e0; color: #b06000; border-color: #feebc8; }
            ...
            <button
              onClick={async () => {
                ...
                try {
                  ...
                  const res = await fetch(`/api/safety-trainings/upload/csv`, {
                    method: "POST",
      ...
      {currentUser?.emp_role !== "member" && (
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 16, fontSize: 12, color: "#64748b" }}>
          {[["#22c55e","30일 이상"],["#eab308","7~30일"],["#ef4444","7일 이하"],["#94a3b8","만료"],["#cbd5e1","미완료"]].map(([color, label]) => (
